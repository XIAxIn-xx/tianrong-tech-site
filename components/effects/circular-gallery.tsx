...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      { image: '/images/tianrong/product-matrix-body-series.png', text: '机器人本体系列' },
      { image: '/images/tianrong/backpack-series.png', text: '模块化背包系列' },
      { image: '/images/tianrong/foot-wheel-module.png', text: '足端与轮足运动模块' },
      { image: '/images/tianrong/rsp-teleop-dark.png', text: 'ROBOX 盒子' },
      { image: '/images/tianrong/rsp-monitor.png', text: '机器人调度平台' },
      { image: '/images/tianrong/logistics-route-a.png', text: '场景化集成服务' }
    ];
