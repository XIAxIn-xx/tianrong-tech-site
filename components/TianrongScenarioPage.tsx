...
const products = [
  {
    ...
    title: "智能背包与传感器",
    category: "硬件产品",
    tagline: "模块化组合，适配多样化巡检需求",
    description: "以标准化背包为载体，按场景需求灵活集成可见光、热成像、气体检测、通信及边缘计算等模块，实现载荷快速配置与现场适配，满足不同场景下的巡检与作业需求。",
  ...
  },
  {
    ...
    category: "硬件产品",
    tagline: "支撑机器人长期自主运行",
    description: "自主充电站是机器人巡检体系的重要组成部分，集成配电、温湿度监测、通信与数据采集等模块，为机器人提供自动快速补能与数据同步支持。",
  ...
  },
  {
    ...
    title: "多模态自主导航系统",
    category: "软件产品",
    tagline: "支撑机器人在复杂环境中自主巡航",
    description: "融合激光与视觉感知SLAM，提供环境建图、精准定位、路径规划和动态避障能力，满足室内外、弱光及动态环境下的巡检通行需求。",
  ...
  },
  {
    ...
    title: "一体化智能调度平台",
    category: "软件产品",
    tagline: "统一调度机器人、任务与巡检作业",
    description: "集成地图与任务管理、设备监控、远程遥操和巡检记录，贯通任务配置、作业执行、异常处置与结果归档。",
  ...
  },
  {
    ...
    category: "软件产品",
    tagline: "让巡检数据形成业务闭环",
    description: "支撑巡检数据的采集、存储、分析、可视化、异常预警和报告生成，为巡检决策与任务优化提供依据。",
